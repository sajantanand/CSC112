...
/**
  *   @brief  overloads output operator; uses the overloaded output operator of pixel class
  * 
  *   @param  out is an reference ostream 
  *   @param  rhs is an constant reference PixelList (user-defined type)
  *   @return out - ostream
  */
...
/**
  *   @brief  overloads []] operator for accessing and writing to arrays by index
  * 
  *   @param  index is an int that indicates where in the array to look
  *   @return referenced pixel
  */
Pixel& PixelList::operator[](int index)
{
    if(size_ == 0)
    {
      cerr << "No list to index!" << endl;
      exit(NO_LIST_TO_INDEX);
    }
...
/**
  *   @brief  overloads []] operator for accessing and reading arrays by index
  * 
  *   @param  index is an int that indicates where in the array to look
  *   @return Pixel
  */
Pixel PixelList::operator[](int index) const
{
    if(size_ == 0)
    {
      cerr << "No list to index!" << endl;
